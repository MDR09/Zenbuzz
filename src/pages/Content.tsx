...
const Content: React.FC = () => {
  ...
  const podcasts = [
    {
      id: 1,
      title: 'SAFAR II THE UNFOLDING STARTUP STORY II EPISODE 03',
      thumbnail: 'p3.webp',
      guest: ' Vidur Pathak',
      duration: '36:06',
      views: '82',
      date: 'June 26, 2025',
      description: 'In our third episode, we dive deep into the real journeys of entrepreneurs, dreamers, and changemakers who dared to start from scratch. Join us as we explore the hustle, challenges, and raw stories behind the scenes that no one talks about.',
      category: 'Real  World experiences',
      season: 'Season 1',
      episode: 'Episode 3',
    ...
    {
      id: 2,
      title: 'SAFAR II THE UNFOLDING STARTUP STORY II Episode 02',
      thumbnail: 'p2.webp',
      guest: 'Vikram Modi',
      duration: '33:43',
      views: '37',
      date: 'June 18, 2025',
      description: 'In our Second episode, we dive deep into the real journeys of entrepreneurs, dreamers, and changemakers who dared to start from scratch. Join us as we explore the hustle, challenges, and raw stories behind the scenes that no one talks about.',
      category: 'Real startup experiences',
      season: 'Season 1',
      episode: 'Episode 2',
    ...
    },
    {
      ...
      views: '210',
      date: 'June 7, 2025',
      description: 'In our very first episode, we dive deep into the real journeys of entrepreneurs, dreamers, and changemakers who dared to start from scratch. Join us as we explore the hustle, challenges, and raw stories behind the scenes that no one talks about.',
      category: 'Real startup experiences',
      season: 'Season 1',
      episode: 'Episode 1',
